...
Naive matmul: The very basic GEMM operation. Non-optimized version.
Tiled Matmul: Does matrix multiply using tiles.
Naive and Tiled FP16: Use half precision in case of memory bound kernels.
Tensor Cores: Use TC for optimal matmul (This is being debugged as of now.)
PART 2: CNN operation
